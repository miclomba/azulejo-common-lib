...
IEventEmitter::IEventEmitter(IEventEmitter &&) noexcept = default;
IEventEmitter &IEventEmitter::operator=(IEventEmitter &&) noexcept = default;
IEventEmitter::~IEventEmitter() noexcept = default;
