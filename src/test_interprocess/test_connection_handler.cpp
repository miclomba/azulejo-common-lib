...
namespace
{
	...
	{
		MockConnHandler(io_context &context) : IConnectionHandler(context) {}
...
TEST(IConnectionHandler, PostReceiveMessages)
{
	...
	EXPECT_CALL(handler->IOAdapter(), AsyncRead(_, _, _, _)).Times(3).WillRepeatedly(DoAll(Invoke(&(handler->IOAdapter()), &IOAdapter::AsyncReadImpl)));
...
TEST(IConnectionHandler, PostReceiveMessagesWithErrorReadingHeader)
{
	...
	EXPECT_CALL(handler->IOAdapter(), AsyncRead(_, _, _, _)).Times(1).WillRepeatedly(DoAll(Invoke(&(handler->IOAdapter()), &IOAdapter::AsyncReadImplWithErrorParamReadingHeader)));
...
TEST(IConnectionHandler, PostReceiveMessagesWithErrorReadingHeaderLength)
{
	...
	EXPECT_CALL(handler->IOAdapter(), AsyncRead(_, _, _, _)).Times(1).WillRepeatedly(DoAll(Invoke(&(handler->IOAdapter()), &IOAdapter::AsyncReadImplWithErrorParamReadingHeaderLength)));
...
TEST(IConnectionHandler, PostReceiveMessagesWithErrorReadingBody)
{
	...
	EXPECT_CALL(handler->IOAdapter(), AsyncRead(_, _, _, _)).Times(2).WillRepeatedly(DoAll(Invoke(&(handler->IOAdapter()), &IOAdapter::AsyncReadImplWithErrorParamReadingBody)));
...
TEST(IConnectionHandler, PostOutgoingMessage)
{
	...
	EXPECT_CALL(handler->IOAdapter(), AsyncWrite(_, _, _)).Times(1).WillRepeatedly(DoAll(Invoke(&(handler->IOAdapter()), &IOAdapter::AsyncWriteImpl)));
...
TEST(IConnectionHandler, PostOutgoingMessages)
{
	...
	EXPECT_CALL(handler->IOAdapter(), AsyncWrite(_, _, _)).Times(2).WillRepeatedly(DoAll(Invoke(&(handler->IOAdapter()), &IOAdapter::AsyncWriteImpl)));
...
TEST(IConnectionHandler, PostOutgoingMessageWithError)
{
	...
	EXPECT_CALL(handler->IOAdapter(), AsyncWrite(_, _, _)).Times(1).WillRepeatedly(DoAll(Invoke(&(handler->IOAdapter()), &IOAdapter::AsyncWriteImplWithErrorParam)));
...
TEST(IConnectionHandler, Connect)
{
	...
	EXPECT_CALL(handler->IOAdapter(), AsyncConnect(_, _, _)).Times(1).WillRepeatedly(DoAll(Invoke(&(handler->IOAdapter()), &IOAdapter::AsyncConnectImpl)));
...
TEST(IConnectionHandler, ConnectWithError)
{
	...
	EXPECT_CALL(handler->IOAdapter(), AsyncConnect(_, _, _)).Times(1).WillRepeatedly(DoAll(Invoke(&(handler->IOAdapter()), &IOAdapter::AsyncConnectImplWithErrorParam)));
