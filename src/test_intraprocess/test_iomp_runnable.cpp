...
#include "test_intraprocess/config.h"
...
namespace
{
	...
	{
		Runnable(const size_t numThreads, const bool setDynamic, const bool setNested) : IOMPRunnable(numThreads, setDynamic, setNested)
		{
		}

		Runnable(const size_t numThreads, const bool setDynamic) : IOMPRunnable(numThreads, setDynamic)
		{
		}

		Runnable(const size_t numThreads) : IOMPRunnable(numThreads)
		{
		}
